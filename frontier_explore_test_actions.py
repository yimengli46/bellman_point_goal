...
if cfg.NAVI.PERCEPTION == 'UNet_Potential':
    ...
    if cfg.PRED.PARTIAL_MAP.INPUT == 'occ_and_sem':
        checkpoint = torch.load(
            f'{cfg.PRED.PARTIAL_MAP.SAVED_FOLDER}/{cfg.PRED.PARTIAL_MAP.INPUT}/experiment_1/best_checkpoint.pth.tar', map_location=device)
        ...
        # ============================== find the nearest frontier ==========================
            ...
            if cfg.NAVI.STRATEGY == 'Optimistic':
                chosen_frontier = fr_utils.get_frontier_nearest_to_goal(
                    agent_map_pose, frontiers, goal_coord, LN, observed_occupancy_map)
                ...
                chosen_frontier = fr_utils.get_frontier_with_DP_accel(
                    top_frontiers, agent_map_pose, dist_occupancy_map, goal_coord, LN)
