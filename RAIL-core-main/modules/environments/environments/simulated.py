...
class WorldBuildingUnityBridge(UnityBridge):
    ...
    def make_world(self, world, scale=10.0):
        ...
        if 'walls' in world.map_data.keys():
...
class OccupancyGridWorld(World):
    ...
    def __init__(self,
        ...
        if 'tables' in map_data.keys():
            self.table_poses_sizes = map_data['tables']
            ...
            self.light_poses = _generate_light_poses(world=World(obstacles, boundary),
