...
VERTEXNAV_UNITY_BASENAME ?= rail_sim_2022_01
VERTEXNAV_CORE_ARGS = \
...
vertexnav-dungeon-data-gen-seeds = \
	...
	$(shell for ii in $$(seq 2000 2049); do echo "$(vertexnav_dungeon_base_dir)/data/training_env_plots/testing_env_$$ii.png"; done)
...
DUNGEON_UNITY_BASENAME ?= rail_sim_2022_01
