...
def main(args):
    ...
    model = vertexnav_lsp.models.VertexLSPOmni(args).to(device)
...
def get_parser():
    ...
    parser.add_argument('--relative_positive_weight_vert',
                        default=8.0,
                        help='Initial learning rate',
                        type=float)
    parser.add_argument('--relative_positive_weight_lsp',
                        default=2.0,
                        help='Initial learning rate',
                        type=float)
