...
result_folder = 'LARGE_TESTING_RESULTS_90degree_Optimistic_PCDHEIGHT_MAP_1STEP_500STEPS'
npy_list = [
    os.path.splitext(os.path.basename(x))[0]
    for x in sorted(glob.glob(f'{output_folder}/{result_folder}/*.npy'))
]
...
for npy_name in npy_list:
    ...
    results_npy = np.load(f'{output_folder}/{result_folder}/{npy_name}.npy',
